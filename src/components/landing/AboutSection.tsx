...
const AboutSection = () => {
  ...
  return (
    <section ref={ref} id="sobre" className="relative bg-lets-black px-6 py-28 md:px-14">
      <div className="pointer-events-none absolute left-[20%] top-[30%] h-[250px] w-[250px] rounded-full bg-lets-blue/[0.05] blur-[100px] orbit-slow" />
      ...
      <div className="mx-auto max-w-[720px] text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} className="mb-5 font-ui text-[10px] font-bold uppercase tracking-[5px] text-lets-blue">Sobre</motion.div>
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: 0.1 }}
          className="mb-6 font-display text-[clamp(40px,6vw,84px)] uppercase leading-[0.95] tracking-[2px] text-lets-white"
        >
        ...
        <motion.div
          ...
          className="mx-auto mb-8 h-[2px] w-12 bg-lets-blue"
        />
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
