...
const CTASection = () => {
  ...
  return (
    <section ref={ref} id="agendar" className="relative overflow-hidden bg-[--bg2] px-6 py-28 text-center md:px-14">
      {/* Multiple ambient blobs for dramatic effect */}
      ...
      <div className="pointer-events-none absolute left-[20%] top-[20%] h-[200px] w-[200px] rounded-full bg-[--accent]/[0.06] blur-[80px] orbit-slow" />
      ...
      <div className="relative mx-auto max-w-[600px]">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} className="mb-5 font-ui text-[10px] font-bold uppercase tracking-[5px] text-[--accent]">Comece agora</motion.div>
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: 0.1 }}
          className="mb-6 font-display text-[clamp(44px,7vw,88px)] uppercase leading-[0.95] tracking-[2px] text-[--w]"
        >
