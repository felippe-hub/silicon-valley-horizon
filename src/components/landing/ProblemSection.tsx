  ...
  return (
    <div className="scroll-layer-wrap relative" style={{ minHeight: "100vh" }}>
      <section
        ref={ref}
        id="problema"
        className="sticky top-0 flex min-h-screen flex-col justify-center overflow-hidden bg-lets-black"
        style={{ zIndex: 1 }}
      >
        ...
        <div className="mx-auto w-full max-w-[1200px] px-6 py-24 md:px-20">
          <div className="grid items-center gap-20 md:grid-cols-2">
            ...
            >
              <div className="mb-5 font-ui text-[10px] font-bold uppercase tracking-[5px] text-lets-blue">O Problema</div>
              <h2 className="mb-6 max-w-[480px] font-display text-[clamp(40px,6vw,84px)] uppercase leading-[0.95] tracking-[2px] text-lets-white">
                Sua rotina já é cheia demais para o marketing virar mais uma função.
              </h2>
              <div className="mb-7 h-[2px] w-12 bg-lets-blue" />
            ...
            >
              {pains.map((p, i) => (
                <motion.div
                  ...
                  className="mb-3 flex items-center gap-4 rounded-xl border border-white/[0.08] bg-white/[0.02] px-6 py-5 transition"
                >
              ...
              >
                <div className="mb-4 font-ui text-[10px] font-bold uppercase tracking-[4px] text-lets-blue">LETS!DOC OPERA</div>
                  ...
                  {tags.map((t, i) => (
                    <motion.span
                      ...
                      className={`rounded-[20px] border px-[18px] py-2 font-ui text-xs font-bold transition-all ${
                        i === 0 ? "border-lets-blue/30 bg-lets-blue/10 text-lets-blue" : "border-white/[0.08] text-white/50"
                      }`}
                    >
                      {t}
                    </motion.span>
